...
class LoanRequest extends Model
{
    ...
    protected function casts(): array
    {
        return [
            ...
            'request_type' => LoanRequestType::class,
    ...
    public static function generateRequestNumber(): string
    {
        ...
        return sprintf('LN-%s-%04d', $date, $sequence);
    }
    ...
    /**
     * Scope a query to filter by loan type.
     */
    public function scopeOfLoanType($query, LoanType $loanType)
    {
